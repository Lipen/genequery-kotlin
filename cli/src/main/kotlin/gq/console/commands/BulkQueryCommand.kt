...
fun geneConversionMapToCSV(
    geneConversionMap: Map<String, Long?>,
...
fun enrichmentResultItemsToCSV(
    enrichmentResultItems: List<EnrichmentResultItem>,
...
fun processQuery(pathToQuery: Path, destPath: Path, dataHolder: DataHolder): Pair<Boolean, Path> {
    try {
        ...
        while (tokenizer.hasMoreTokens()) {
            rawGenes.add(tokenizer.nextToken())
        }
        ...
        geneConversionMapToCSV(
            searchResult.geneConversionMap, searchResult.identifiedGeneFormat,
        ...
        enrichmentResultItemsToCSV(
            searchResult.enrichmentResultItems,
            searchResult.gseToTitle,
            enrichmentResultFilePath
        )
