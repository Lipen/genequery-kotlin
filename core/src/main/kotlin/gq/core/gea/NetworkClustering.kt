...
class ScoredEnrichedItemsGroup(
    val groupId: Int,
...
fun groupEnrichedItemsByClusters(
    ...
    scoreEvaluationStrategy: EnrichedGroupScoreEvaluationStrategy
): Map<Int, ScoredEnrichedItemsGroup> {
    val nameToEnrichedItem =
        enrichedItems.associate { Pair(GQModule.joinFullName(it.gse, it.gpl, it.moduleNumber), it) }
