    ...
    fun testGroupEnrichedItemsByClusters() {
        ...
        val clusterCollection = GQNetworkClusterCollection(
            listOf(
                ...
                GQNetworkCluster(
                    4,
                    (1000..1010).map { GQModule.joinFullName(it / 10, it / 10, it % 10) }.toSet(),
                    "ann_4"
                )
            )
        )
